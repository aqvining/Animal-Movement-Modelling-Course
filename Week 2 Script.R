...
outlierCheck <- function(values, outlierLevel = 3) { #Setting a default means the variable doesn't have to be entered when calling function
...
###Practice! Write a function that takes two vectors and a threshold value as input. It should output the number of indices that have
